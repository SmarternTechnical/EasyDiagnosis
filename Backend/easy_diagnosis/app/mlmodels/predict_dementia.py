...
models_dir = settings.BASE_DIR / 'app' / 'mlmodels'/'mlmodelfiles' /'audio_classification_dementia'
...
def predict_dementia_audio_class(filepath):
    ...
    final_class = "Normal" if final_prediction == 1 else "dementia"
