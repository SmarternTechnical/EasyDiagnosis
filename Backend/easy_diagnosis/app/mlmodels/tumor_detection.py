...
import os
model_path = settings.BASE_DIR / "app/mlmodels/mlmodelfiles/tumor_classification_model.h5"
...
#model = tf.keras.models.load_model("EasyDiagnosis/Backend/easy_diagnosis/app/mlmodels/mlmodelfiles/tumor_classification_model.h5")
